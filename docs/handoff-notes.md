...
- **A test lender account exists**: `test-lender@creditsetu.local` / `phase12-test-pw-2026`, created via the Supabase Auth admin API, pre-confirmed. Change the password or delete it before this goes anywhere beyond local development.
